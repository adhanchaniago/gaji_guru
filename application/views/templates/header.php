...
<head>
	...
	<meta name="description" content="Sistem Informasi Penggajian SMP IT FATWAH">
	<meta name="keywords" content="Sistem Informasi Penggajian SMPI IT FATWAH>
	<meta name="author" content="Jihad">
	<title><?= $title ?> - SMP IT Fatwah</title>
	<link rel="apple-touch-icon" href="<?= base_url() ?>assets/images/ico/apple-icon-120.png">
	<link rel="shortcut icon" type="image/x-icon" href="<?= base_url() ?>assets/images/logo/smp.jpeg">
	<link
		...
		<ul class="nav navbar-nav flex-row">
			<li class="nav-item mr-auto"><a class="navbar-brand" href="<?= base_url('dashboard') ?>">
					<img class="brand-logo"
						 ...
						 src="<?= base_url() ?>assets/images/logo/smp.jpeg"/>
					<h3 class="brand-text">SMP IT FATWAH</h3></a></li>
