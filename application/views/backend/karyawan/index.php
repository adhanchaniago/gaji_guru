		...
		<div class="card box-shadow-2">
			...
			<div class="card-header">
				...
				<button type="button" class="btn btn-primary btn-bg-gradient-x-purple-blue box-shadow-2"
					...
					<i class="ft-plus-circle"></i> Tambah data Guru
				</button>
				<?php endif; ?>
			</div>
			<hr>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<fieldset class="form-group floating-label-form-group">
					...
					<input type="text" class="form-control" id="nohp" name="nomor_hp" placeholder="Nomor boleh kosong"
						   autocomplete="off">
				</fieldset>
				<fieldset class="form-group floating-label-form-group">
					<label for="mapel">Mata Pelajaran</label>
					<input type="text" class="form-control" id="mapel" name="mapel" placeholder="mapel boleh kosong"
						   autocomplete="off">
				</fieldset>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<fieldset class="form-group floating-label-form-group">
					...
					<input type="text" class="form-control" id="edit_mapel" name="mapel" placeholder="Mapel"
						   autocomplete="off" required>
				</fieldset>
			<div class="modal-footer">
				<input type="reset" class="btn btn-secondary btn-bg-gradient-x-red-pink" data-dismiss="modal"
